...
fun RankingContent(
    ...
    Box(
        ...
        BotonScreen(
            ...
            onClick = {},
            modifier = Modifier.align(Alignment.TopStart).padding(top = 70.dp, start = 18.dp)
        )
        BotonScreen(
            textoBoton = "Juegos",
            ...
            onClick = {},
            modifier = Modifier.align(Alignment.TopStart).padding(top = 70.dp, start = 125.dp)
        )
        ...
        Text(
            ...
            color = Color.Gray,
            fontSize = 16.sp,
            modifier = Modifier.align(Alignment.TopStart).padding(top = 140.dp, start = 18.dp)
        ...
        LazyColumn(
            ...
            items(ListaRanking.rankingUsuarios) { usuario ->
